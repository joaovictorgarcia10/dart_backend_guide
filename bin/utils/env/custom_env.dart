import 'dart:io';
import '../extensions/parser_extension.dart';
...
class CustomEnv {
  ...
  static Future<T> get<T>({required String key}) async {
    ...
    return _map[key]!.toType(T); // Parseado com o ParserExtension
  }

  static Future<void> _load() async {
    List<String> linhas = (await _readFile()).split("\n");

    // Populando o map {key : value} utilizando um for in
